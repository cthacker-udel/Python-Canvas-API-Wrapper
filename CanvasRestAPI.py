...
class CanvasDiscussionTopic(CanvasClient):
    ...
    def mark_entry_as_unread_course_id(self):
    ...
    def mark_entry_as_unread_group_id(self):
    ...
    def unsubscribe_topic_course_id(self):

        url = self.base_url + '/api/v1/courses/{}/discussion_topics/{}/subscribed'.format(self.client.CanvasDiscussionTopics.course_id,self.client.CanvasDiscussionTopics.discussion_topic_id)

        request = requests.delete(url,headers={'Authorization {}'.format(self.client.CanvasDiscussionTopics.course_id,self.client.CanvasDiscussionTopics.discussion_topic_id)})

        pprint(request)

    def unsubscribe_topic_group_id(self):
...
class CanvasEnrollmentTerms(CanvasClient):
    ...
    def retrieve_enrollment_term(self):
...
class CanvasEnrollments(CanvasClient):
    ...
    def list_enrollments_user_id(self):

        url = self.base_url + '/api/v1/users/{}/enrollments'.format(self.client.CanvasEnrollment.user_id)
    ...
    def enroll_user_course_id(self):
...
class CanvasExternalTool(CanvasClient):
    ...
    def get_sessionless_launch_url_account_id(self):

        url = self.base_url + '/api/v1/accounts/{}/external_tools/sessionless_launch'.format(self.client.CanvasExternalTools.account_id)
    ...
    def get_visible_course_navigation_tools(self):

        url = self.base_url + '/api/v1/external_tools/visible_course_nav_tools'
...
class CanvasFeatureFlag(CanvasClient):
    ...
    def list_features_account_id(self):

        url = self.base_url + '/api/v1/accounts/{}/features'.format(self.client.CanvasFeatureFlags.account_id)
    ...
    def list_enabled_features_user_id(self):

        url = self.base_url + '/api/v1/users/{}/features/enabled'.format(self.client.CanvasFeatureFlags.user_id)
    ...
    def list_environment_features(self):
        ...
        url = self.base_url = '/api/v1/features/environment'

        request = requests.get(url,headers={'Authorization {}'.format(self.token)})

        pprint(request)

    def get_feature_flag_course_id(self):
    ...
    def get_feature_flag_account_id(self):
...
class CanvasFiles(CanvasClient):
    ...
    def list_files_course_id(self):

        url = self.base_url + '/api/v1/courses/{}/files'.format(self.client.CanvasFile.course_id)

        request = requests.get(url,headers={'Authorization {}'.format(self.token)},params=self.client.CanvasFile.generate_queries())

        pprint(request)

    def list_files_user_id(self):

        url = self.base_url + '/api/v1/users/{}/files'.format(self.client.CanvasFile.user_id)

        request = requests.get(url,headers={'Authorization {}'.format(self.token)},params=self.client.CanvasFile.generate_queries())

        pprint(request)

    def list_files_group_id(self):

        url = self.base_url + '/api/v1/groups/{}/files'.format(self.client.CanvasFile.group_id)

        request = requests.get(url,headers={'Authorization {}'.format(self.token)},params=self.client.CanvasFile.generate_queries())

        pprint(request)

    def list_files_folder_id(self):

        url = self.base_url + '/api/v1/folders/{}/files'.format(self.client.CanvasFile.folder_id)
    ...
    def get_file_file_id_post(self):
    ...
    def list_all_folders_course_id(self):

        url = self.base_url + '/api/v1/courses/{}/folders'.format(self.client.CanvasFile.course_id)

        request = requests.get(url,headers={'Authorization {}'.format(self.token)})

        pprint(request)

    def list_all_folders_user_id(self):

        url = self.base_url + '/api/v1/users/{}/folders'.format(self.client.CanvasFile.user_id)
