...
class CanvasBlueprint(CanvasClient):
    ...
    def show_blueprint_import(self):
        ...
        url = self.base_url + '/api/v1/courses/{}/blueprint_subscriptions/{}/migrations/{}'.format(self.client.CanvasBlueprint.course_id,self.client.CanvasBlueprint.subscription_id,self.client.CanvasBlueprint.migration_id)
...
class CanvasBookmarks(CanvasClient):
    ...
    def update_bookmark(self):
        ...
        request = requests.put(url,headers={'Authorization {}'.format(self.token)},json=self.client.CanvasBookmark.generate_queries())
...
class CanvasCalendarEvents(CanvasClient):
    ...
    def update_calendar_event(self):
        ...
        request = requests.put(url,headers={'Authorization {}'.format(self.token)},json=self.client.CanvasCalendarEvents.generate_queries())
    ...
    def create_or_update_timetable_events_directly(self):
        ...
        url = self.base_url + '/api/v1/courses/{}/calendar_events/timetable_events'.format(self.client.CanvasCalendarEvents.course_id)
...
class CanvasCollaborations(CanvasClient):
    ...
    def list_potential_members(self):
        ...
        url = self.base_url + '/api/v1/courses/{}/potential_collaborators'.format(self.client.CanvasCollaboration.course_id)
    ...
    def list_potential_members_group_id(self):
        ...
        url = self.base_url + '/api/v1/groups/{}/potential_collaborators'.format(self.client.CanvasCollaboration.group_id)
...
class CanvasCommunicationMessages(CanvasClient):
    ...
    def delete_communication_channel_v1(self):
        ...
        url = self.base_url + '/api/v1/users/{}/communication_channels/{}'.format(self.client.CanvasCommMessages.user_id,self.client.CanvasCommMessages.communication_channel_id)
...
class CanvasContentExport(CanvasClient):
    ...
    def show_content_export_course_id(self):
        ...
        url = self.base_url + '/api/v1/courses/{}/content_exports/{}'.format(self.client.CanvasContentExports.course_id,self.client.CanvasContentExports.content_export_id)
    ...
    def export_content_group_id(self):
        ...
        request = requests.post(url,headers={'Authorization {}'.fomrat(self.token)},json=self.client.CanvasContentExports.generate_queries())
...
class CanvasContentMigration(CanvasClient):
    ...
    def list_migration_issues_group_id(self):
        ...
        url = self.base_url = '/api/v1/groups/{}/content_migrations/{}/migration_issues'.format(self.client.CanvasContentMigration.group_id,self.client.CanvasContentMigration.content_migration_id)
    ...
    def list_migration_issues_user_id(self):
        ...
        url = self.base_url + '/api/v1/users/{}/content_migrations/{}/migration_issues'.format(self.client.CanvasContentMigration.user_id,self.client.CanvasContentMigration.content_migration_id)
    ...
    def get_migration_issue_user_id(self):
        ...
        url = self.base_url + '/api/v1/users/{}/content_migrations/{}/migration_issues/{}'.format(self.client.CanvasContentMigration.user_id,self.client.CanvasContentMigration.content_migration_id,self.client.CanvasContentMigration.migration_issue_id)
    ...
    def update_migration_issue_account_id(self):
        ...
        request = requests.put(url,headers={'Authorization {}'.format(self.token)},json=self.client.CanvasContentMigration.generate_queries())
    ...
    def update_migration_issue_group_id(self):
        ...
        url = self.base_url + '/api/v1/groups/{}/content_migrations/{}/migration_issues/{}'.format(self.client.CanvasContentMigration.group_id,self.client.CanvasContentMigration.content_migration_id,self.client.CanvasContentMigration.migration_issue_id)
    ...
    def get_content_migration_account_id(self):
        ...
        url = self.base_url + '/api/v1/accounts/{}/content_migrations/{}'.format(self.client.CanvasContentMigration.account_id,self.client.CanvasContentMigration.content_migration_id)
    ...
    def get_content_migration_course_id(self):
        ...
        url = self.base_url + '/api/v1/courses/{}/content_migrations/{}'.format(self.client.CanvasContentMigration.course_id,self.client.CanvasContentMigration.content_migration_id)
    ...
    def get_content_migration_group_id(self):
        ...
        url = self.base_url + '/api/v1/groups/{}/content_migrations/{}'.format(self.client.CanvasContentMigration.group_id,self.client.CanvasContentMigration.content_migration_id)
    ...
    def get_content_migration_user_id(self):
        ...
        url = self.base_url + '/api/v1/users/{}/content_migrations/{}'.format(self.client.CanvasContentMigration.user_id,self.client.CanvasContentMigration.content_migration_id)
    ...
    def list_migration_system_account_id(self):
        ...
        url = self.base_url + '/api/v1/accounts/{}/content_migrations/migrators'.format(self.client.CanvasContentMigration.account_id)
